...
const exerciseLibrary: Record<string, Exercise[]> = {
  'Chest': [
    ...
    { id: 103, name: 'Cable Flyes', muscleGroups: 'Chest • Cable', videoId: '', sets: 3, aiSuggestion: { weight: 40, reps: '12-15' } },
    ...
    { id: 108, name: 'Chest Press Machine', muscleGroups: 'Chest • Machine', videoId: '', sets: 3, aiSuggestion: { weight: 140, reps: '10-12' } },
    { id: 109, name: 'Push-ups', muscleGroups: 'Chest • Bodyweight', videoId: 'KEFQyLkDYtI', sets: 3, aiSuggestion: { weight: 0, reps: '15-20' } },
    { id: 110, name: 'Pec Deck', muscleGroups: 'Chest • Machine', videoId: '', sets: 3, aiSuggestion: { weight: 120, reps: '12-15' } },
  ],
  'Back': [
    ...
    { id: 203, name: 'Pull-ups', muscleGroups: 'Lats • Biceps • Bodyweight', videoId: '', sets: 4, aiSuggestion: { weight: 0, reps: '8-12' } },
    { id: 204, name: 'Lat Pulldown', muscleGroups: 'Lats • Cable', videoId: 'iKrKgWR9wbY', sets: 3, aiSuggestion: { weight: 140, reps: '10-12' } },
    { id: 205, name: 'Seated Cable Row', muscleGroups: 'Back • Cable', videoId: '', sets: 3, aiSuggestion: { weight: 130, reps: '10-12' } },
    { id: 206, name: 'Dumbbell Rows', muscleGroups: 'Back • Dumbbells', videoId: 'DhewkuU_95s', sets: 3, aiSuggestion: { weight: 70, reps: '10-12' } },
    { id: 207, name: 'T-Bar Rows', muscleGroups: 'Back • Barbell', videoId: '', sets: 4, aiSuggestion: { weight: 135, reps: '8-10' } },
  ...
  'Shoulders': [
    { id: 301, name: 'Overhead Press', muscleGroups: 'Shoulders • Triceps • Barbell', videoId: '', sets: 4, aiSuggestion: { weight: 115, reps: '8-10' } },
    { id: 302, name: 'Lateral Raises', muscleGroups: 'Side Delts • Dumbbells', videoId: '', sets: 4, aiSuggestion: { weight: 25, reps: '12-15' } },
    { id: 303, name: 'Face Pulls', muscleGroups: 'Rear Delts • Cable', videoId: '', sets: 3, aiSuggestion: { weight: 40, reps: '15-20' } },
    ...
    { id: 307, name: 'Cable Lateral Raises', muscleGroups: 'Side Delts • Cable', videoId: '', sets: 3, aiSuggestion: { weight: 15, reps: '12-15' } },
    { id: 308, name: 'Front Raises', muscleGroups: 'Front Delts • Dumbbells', videoId: '', sets: 3, aiSuggestion: { weight: 25, reps: '12-15' } },
    { id: 309, name: 'Upright Rows', muscleGroups: 'Shoulders • Traps • Barbell', videoId: '', sets: 3, aiSuggestion: { weight: 65, reps: '10-12' } },
    { id: 310, name: 'Shrugs', muscleGroups: 'Traps • Dumbbells', videoId: '6hNudn7Peco', sets: 3, aiSuggestion: { weight: 70, reps: '12-15' } },
  ],
  'Biceps': [
    { id: 401, name: 'Barbell Curl', muscleGroups: 'Biceps • Barbell', videoId: '', sets: 4, aiSuggestion: { weight: 75, reps: '10-12' } },
    { id: 402, name: 'Hammer Curls', muscleGroups: 'Biceps • Brachialis • Dumbbells', videoId: '', sets: 3, aiSuggestion: { weight: 35, reps: '10-12' } },
    ...
    { id: 404, name: 'Preacher Curls', muscleGroups: 'Biceps • Machine', videoId: '', sets: 3, aiSuggestion: { weight: 55, reps: '10-12' } },
    { id: 405, name: 'Cable Curls', muscleGroups: 'Biceps • Cable', videoId: '', sets: 3, aiSuggestion: { weight: 40, reps: '12-15' } },
    { id: 406, name: 'Concentration Curls', muscleGroups: 'Biceps • Dumbbells', videoId: '', sets: 3, aiSuggestion: { weight: 30, reps: '10-12' } },
    { id: 407, name: 'EZ Bar Curl', muscleGroups: 'Biceps • EZ Bar', videoId: '', sets: 3, aiSuggestion: { weight: 65, reps: '10-12' } },
    { id: 408, name: 'Spider Curls', muscleGroups: 'Biceps • Dumbbells', videoId: '', sets: 3, aiSuggestion: { weight: 25, reps: '10-12' } },
    { id: 409, name: 'Reverse Curls', muscleGroups: 'Forearms • Biceps • Barbell', videoId: '', sets: 3, aiSuggestion: { weight: 45, reps: '12-15' } },
  ],
  'Triceps': [
    { id: 501, name: 'Tricep Pushdowns', muscleGroups: 'Triceps • Cable', videoId: '', sets: 4, aiSuggestion: { weight: 60, reps: '10-12' } },
    { id: 502, name: 'Skull Crushers', muscleGroups: 'Triceps • EZ Bar', videoId: '', sets: 3, aiSuggestion: { weight: 65, reps: '10-12' } },
    ...
    { id: 505, name: 'Tricep Kickbacks', muscleGroups: 'Triceps • Dumbbells', videoId: '', sets: 3, aiSuggestion: { weight: 20, reps: '12-15' } },
    { id: 506, name: 'Diamond Push-ups', muscleGroups: 'Triceps • Bodyweight', videoId: '', sets: 3, aiSuggestion: { weight: 0, reps: '12-15' } },
  ...
  'Legs': [
    ...
    { id: 602, name: 'Romanian Deadlift', muscleGroups: 'Hamstrings • Glutes • Barbell', videoId: '', sets: 4, aiSuggestion: { weight: 185, reps: '8-10' } },
    { id: 603, name: 'Leg Press', muscleGroups: 'Quads • Glutes • Machine', videoId: 'sEM_zo9w2ss', sets: 4, aiSuggestion: { weight: 360, reps: '10-12' } },
    { id: 604, name: 'Leg Curls', muscleGroups: 'Hamstrings • Machine', videoId: '', sets: 3, aiSuggestion: { weight: 100, reps: '12-15' } },
    { id: 605, name: 'Calf Raises', muscleGroups: 'Calves • Machine', videoId: '', sets: 4, aiSuggestion: { weight: 150, reps: '15-20' } },
    { id: 606, name: 'Leg Extensions', muscleGroups: 'Quads • Machine', videoId: '0fl1RRgJ83I', sets: 3, aiSuggestion: { weight: 120, reps: '12-15' } },
    { id: 607, name: 'Bulgarian Split Squats', muscleGroups: 'Quads • Glutes • Dumbbells', videoId: '', sets: 3, aiSuggestion: { weight: 50, reps: '10-12' } },
    { id: 608, name: 'Hip Thrusts', muscleGroups: 'Glutes • Barbell', videoId: '', sets: 4, aiSuggestion: { weight: 185, reps: '10-12' } },
    { id: 609, name: 'Lunges', muscleGroups: 'Quads • Glutes • Dumbbells', videoId: '', sets: 3, aiSuggestion: { weight: 40, reps: '10-12' } },
    { id: 610, name: 'Hack Squat', muscleGroups: 'Quads • Machine', videoId: '63tboDKQksc', sets: 4, aiSuggestion: { weight: 180, reps: '10-12' } },
  ],
  'Core': [
    { id: 701, name: 'Cable Crunches', muscleGroups: 'Abs • Cable', videoId: '', sets: 3, aiSuggestion: { weight: 80, reps: '15-20' } },
    { id: 702, name: 'Hanging Leg Raises', muscleGroups: 'Abs • Bodyweight', videoId: '', sets: 3, aiSuggestion: { weight: 0, reps: '12-15' } },
    { id: 703, name: 'Ab Wheel Rollouts', muscleGroups: 'Abs • Equipment', videoId: '', sets: 3, aiSuggestion: { weight: 0, reps: '10-15' } },
