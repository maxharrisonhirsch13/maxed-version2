...
const exerciseLibrary: Record<string, Exercise[]> = {
  'Chest': [
    { id: 101, name: 'Bench Press', muscleGroups: 'Chest • Triceps • Barbell', videoId: 'vcBig73ojpE', sets: 4, aiSuggestion: { weight: 185, reps: '8-10' } },
    ...
    { id: 103, name: 'Cable Flyes', muscleGroups: 'Chest • Cable', videoId: 'OPYrUGZL8nU', sets: 3, aiSuggestion: { weight: 40, reps: '12-15' } },
    { id: 104, name: 'Dips', muscleGroups: 'Lower Chest • Triceps • Bodyweight', videoId: 'yN6Q1UI_xkE', sets: 3, aiSuggestion: { weight: 0, reps: '10-15' } },
    ...
    { id: 108, name: 'Chest Press Machine', muscleGroups: 'Chest • Machine', videoId: 'dMQdd40Y3FQ', sets: 3, aiSuggestion: { weight: 140, reps: '10-12' } },
    { id: 109, name: 'Push-ups', muscleGroups: 'Chest • Bodyweight', videoId: 'KEFQyLkDYtI', sets: 3, aiSuggestion: { weight: 0, reps: '15-20' } },
    { id: 110, name: 'Pec Deck', muscleGroups: 'Chest • Machine', videoId: 'NsEbXsTwas8', sets: 3, aiSuggestion: { weight: 120, reps: '12-15' } },
  ],
  'Back': [
    { id: 201, name: 'Deadlift', muscleGroups: 'Back • Hamstrings • Barbell', videoId: 'VL5Ab0T07e4', sets: 5, aiSuggestion: { weight: 315, reps: '5-8' } },
    { id: 202, name: 'Barbell Rows', muscleGroups: 'Back • Biceps • Barbell', videoId: 'axoeDmW0oAY', sets: 4, aiSuggestion: { weight: 155, reps: '8-10' } },
    { id: 203, name: 'Pull-ups', muscleGroups: 'Lats • Biceps • Bodyweight', videoId: 'poyr8KenUfc', sets: 4, aiSuggestion: { weight: 0, reps: '8-12' } },
    { id: 204, name: 'Lat Pulldown', muscleGroups: 'Lats • Cable', videoId: 'iKrKgWR9wbY', sets: 3, aiSuggestion: { weight: 140, reps: '10-12' } },
    { id: 205, name: 'Seated Cable Row', muscleGroups: 'Back • Cable', videoId: 'spKGN0XzErU', sets: 3, aiSuggestion: { weight: 130, reps: '10-12' } },
    ...
    { id: 208, name: 'Chin-ups', muscleGroups: 'Lats • Biceps • Bodyweight', videoId: 'D-TL5hDQucI', sets: 3, aiSuggestion: { weight: 0, reps: '8-12' } },
    { id: 209, name: 'Straight Arm Pulldown', muscleGroups: 'Lats • Cable', videoId: 'gDtXrJWPdlY', sets: 3, aiSuggestion: { weight: 50, reps: '12-15' } },
  ],
  'Shoulders': [
    { id: 301, name: 'Overhead Press', muscleGroups: 'Shoulders • Triceps • Barbell', videoId: '_RlRDWO2jfg', sets: 4, aiSuggestion: { weight: 115, reps: '8-10' } },
    { id: 302, name: 'Lateral Raises', muscleGroups: 'Side Delts • Dumbbells', videoId: 'v_ZkxWzYnMc', sets: 4, aiSuggestion: { weight: 25, reps: '12-15' } },
    { id: 303, name: 'Face Pulls', muscleGroups: 'Rear Delts • Cable', videoId: 'eIq5CB9JfKE', sets: 3, aiSuggestion: { weight: 40, reps: '15-20' } },
    { id: 304, name: 'Dumbbell Shoulder Press', muscleGroups: 'Shoulders • Dumbbells', videoId: 'SgyUoY0IZ7A', sets: 4, aiSuggestion: { weight: 50, reps: '8-10' } },
    ...
    { id: 308, name: 'Front Raises', muscleGroups: 'Front Delts • Dumbbells', videoId: 'qfc70k40318', sets: 3, aiSuggestion: { weight: 25, reps: '12-15' } },
    { id: 309, name: 'Upright Rows', muscleGroups: 'Shoulders • Traps • Barbell', videoId: 'k8IwhjE8rHQ', sets: 3, aiSuggestion: { weight: 65, reps: '10-12' } },
    { id: 310, name: 'Shrugs', muscleGroups: 'Traps • Dumbbells', videoId: '6hNudn7Peco', sets: 3, aiSuggestion: { weight: 70, reps: '12-15' } },
  ],
  'Biceps': [
    { id: 401, name: 'Barbell Curl', muscleGroups: 'Biceps • Barbell', videoId: 'i1YgFZB6alI', sets: 4, aiSuggestion: { weight: 75, reps: '10-12' } },
    { id: 402, name: 'Hammer Curls', muscleGroups: 'Biceps • Brachialis • Dumbbells', videoId: 'GNO4OtYoCYk', sets: 3, aiSuggestion: { weight: 35, reps: '10-12' } },
    ...
    { id: 404, name: 'Preacher Curls', muscleGroups: 'Biceps • Machine', videoId: 'GNO4OtYoCYk', sets: 3, aiSuggestion: { weight: 55, reps: '10-12' } },
    { id: 405, name: 'Cable Curls', muscleGroups: 'Biceps • Cable', videoId: 'GNO4OtYoCYk', sets: 3, aiSuggestion: { weight: 40, reps: '12-15' } },
    ...
    { id: 407, name: 'EZ Bar Curl', muscleGroups: 'Biceps • EZ Bar', videoId: 'GNO4OtYoCYk', sets: 3, aiSuggestion: { weight: 65, reps: '10-12' } },
    { id: 408, name: 'Spider Curls', muscleGroups: 'Biceps • Dumbbells', videoId: 'GNO4OtYoCYk', sets: 3, aiSuggestion: { weight: 25, reps: '10-12' } },
    { id: 409, name: 'Reverse Curls', muscleGroups: 'Forearms • Biceps • Barbell', videoId: 'i5h3myNHVFk', sets: 3, aiSuggestion: { weight: 45, reps: '12-15' } },
  ],
  'Triceps': [
    { id: 501, name: 'Tricep Pushdowns', muscleGroups: 'Triceps • Cable', videoId: 'mpZ9VRisAyw', sets: 4, aiSuggestion: { weight: 60, reps: '10-12' } },
    { id: 502, name: 'Skull Crushers', muscleGroups: 'Triceps • EZ Bar', videoId: 'OpRMRhr0Ycc', sets: 3, aiSuggestion: { weight: 65, reps: '10-12' } },
    ...
    { id: 505, name: 'Tricep Kickbacks', muscleGroups: 'Triceps • Dumbbells', videoId: '94DXwlcX8Po', sets: 3, aiSuggestion: { weight: 20, reps: '12-15' } },
    { id: 506, name: 'Diamond Push-ups', muscleGroups: 'Triceps • Bodyweight', videoId: 'popGXI-qs98', sets: 3, aiSuggestion: { weight: 0, reps: '12-15' } },
    { id: 507, name: 'Rope Pushdowns', muscleGroups: 'Triceps • Cable', videoId: 'LzwgB15UdO8', sets: 3, aiSuggestion: { weight: 45, reps: '12-15' } },
  ],
  'Legs': [
    { id: 601, name: 'Squat', muscleGroups: 'Quads • Glutes • Barbell', videoId: 'sdeQjm7avi8', sets: 5, aiSuggestion: { weight: 225, reps: '8-10' } },
    ...
    { id: 604, name: 'Leg Curls', muscleGroups: 'Hamstrings • Machine', videoId: 'H6mRkx1x77k', sets: 3, aiSuggestion: { weight: 100, reps: '12-15' } },
    { id: 605, name: 'Calf Raises', muscleGroups: 'Calves • Machine', videoId: 'RcKQbiL-ZOc', sets: 4, aiSuggestion: { weight: 150, reps: '15-20' } },
    ...
    { id: 608, name: 'Hip Thrusts', muscleGroups: 'Glutes • Barbell', videoId: 'xDmFkJxPzeM', sets: 4, aiSuggestion: { weight: 185, reps: '10-12' } },
    { id: 609, name: 'Lunges', muscleGroups: 'Quads • Glutes • Dumbbells', videoId: 'GgW5EtBrCuE', sets: 3, aiSuggestion: { weight: 40, reps: '10-12' } },
    { id: 610, name: 'Hack Squat', muscleGroups: 'Quads • Machine', videoId: '63tboDKQksc', sets: 4, aiSuggestion: { weight: 180, reps: '10-12' } },
  ],
  'Core': [
    { id: 701, name: 'Cable Crunches', muscleGroups: 'Abs • Cable', videoId: '1G0y8D5rFDc', sets: 3, aiSuggestion: { weight: 80, reps: '15-20' } },
    { id: 702, name: 'Hanging Leg Raises', muscleGroups: 'Abs • Bodyweight', videoId: 'Pr1ieGZ5atk', sets: 3, aiSuggestion: { weight: 0, reps: '12-15' } },
    { id: 703, name: 'Ab Wheel Rollouts', muscleGroups: 'Abs • Equipment', videoId: '1G0y8D5rFDc', sets: 3, aiSuggestion: { weight: 0, reps: '10-15' } },
    { id: 704, name: 'Plank', muscleGroups: 'Core • Bodyweight', videoId: '1G0y8D5rFDc', sets: 3, aiSuggestion: { weight: 0, reps: '45-60s' } },
    { id: 705, name: 'Russian Twists', muscleGroups: 'Obliques • Dumbbells', videoId: 'u6GVYTsxEhw', sets: 3, aiSuggestion: { weight: 25, reps: '20' } },
    { id: 706, name: 'Decline Sit-ups', muscleGroups: 'Abs • Bodyweight', videoId: 'F6PhNnlb-14', sets: 3, aiSuggestion: { weight: 0, reps: '15-20' } },
  ],
};
