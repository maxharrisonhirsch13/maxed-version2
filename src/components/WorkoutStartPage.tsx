...
const celebrityWorkoutsByGroup: Record<string, CelebrityWorkout[]> = {
  Chest: [
    ...
    { id: 103, name: "Hemsworth's Chest & Power", celebrity: 'Chris Hemsworth', exercises: 5, difficulty: 'Intermediate', equipment: ['barbell', 'dumbbells', 'cable'] },
    ...
    { id: 110, name: "Mike O'Hearn's Power Chest", celebrity: "Mike O'Hearn", exercises: 6, difficulty: 'Advanced', equipment: ['barbell', 'dumbbells', 'machine'] },
  ...
  Back: [
    ...
    { id: 211, name: "Lexx Little's Back Builder", celebrity: 'Lexx Little', exercises: 6, difficulty: 'Intermediate', equipment: ['barbell', 'dumbbells', 'cable', 'machine'] },
  ],
  Shoulders: [
    ...
    { id: 309, name: "Derek MPMD's Shoulder Routine", celebrity: 'Derek (MPMD)', exercises: 5, difficulty: 'Intermediate', equipment: ['dumbbells', 'cable', 'machine'] },
  ...
  Legs: [
    ...
    { id: 710, name: "David Laid's Leg Aesthetics", celebrity: 'David Laid', exercises: 5, difficulty: 'Intermediate', equipment: ['barbell', 'dumbbells'] },
  ...
  Core: [
    ...
    { id: 806, name: "Alex Eubank's Ab Shred", celebrity: 'Alex Eubank', exercises: 4, difficulty: 'Intermediate', equipment: [] },
  ],
  Push: [
    ...
    { id: 903, name: "CBum's Push Routine", celebrity: 'Chris Bumstead', exercises: 7, difficulty: 'Advanced', equipment: ['barbell', 'dumbbells', 'cable', 'machine'] },
    ...
    { id: 909, name: "Lexx Little's Push Pump", celebrity: 'Lexx Little', exercises: 6, difficulty: 'Intermediate', equipment: ['barbell', 'dumbbells', 'cable', 'machine'] },
  ...
  Pull: [
    ...
    { id: 1009, name: "Lexx Little's Pull Builder", celebrity: 'Lexx Little', exercises: 6, difficulty: 'Intermediate', equipment: ['barbell', 'dumbbells', 'cable', 'machine'] },
  ...
  'Shoulders & Arms': [
    ...
    { id: 1402, name: "CBum's Delts & Arms", celebrity: 'Chris Bumstead', exercises: 7, difficulty: 'Advanced', equipment: ['dumbbells', 'cable', 'machine'] },
