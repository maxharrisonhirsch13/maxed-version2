...
import { X, Play, Pause, Square, Check, Loader2, Heart, Flame, Zap, TrendingUp, Activity, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      {finished && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-[60] flex items-center justify-center p-4">
          <div className="w-full max-w-sm bg-[#1a1a1a] rounded-3xl p-6 text-center">
            ...
            <h2 className="font-bold text-xl mb-2">Great Work!</h2>
            <p className="text-gray-400 text-sm mb-6">{formatTime(elapsed)}</p>
            <button
              onClick={handleFinish}
              disabled={saving}
